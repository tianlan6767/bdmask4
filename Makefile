...
include_paths := src              \
	...
	/usr/include/boost \
	/media/ps/data1/train/LQ/task/lean/libtorch/include \
	/media/ps/data1/train/LQ/task/lean/libtorch/include/torch/csrc/api/include

# 定义库文件路径，只需要写路径，不需要写-L
library_paths := $(cuda_home)/lib64 $(syslib) $(cpp_pkg)/opencv4.2/lib /media/ps/data1/train/LQ/task/lean/libtorch/lib
