...
jf_train = '/media/ps/data/train/LQ/task/bdm/bdmask/workspace/code/trt/data/data2/train/train.json'
imgs_train = '/media/ps/data/train/LQ/task/bdm/bdmask/workspace/code/trt/data/data2/train'
...
def main():
    ...
    parser.add_argument(
        "--weights",
        default="/media/ps/data/train/LQ/task/bdm/bdmask/workspace/code/trt/model/OQC/used/model_0413999.pth",
        metavar="FILE",
        help="path to the output onnx file",
    )
    parser.add_argument(
        "--output",
        default="/media/ps/data/train/LQ/task/bdm/bdmask/workspace/code/trt/model/OQC/model3",
        metavar="FILE",
        help="path to the output onnx file",
    )
    parser.add_argument(
