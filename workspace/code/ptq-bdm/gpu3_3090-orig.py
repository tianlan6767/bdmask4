...
jf = r'/media/ps/train/LQ/project/OQC/0000/go/annotations/train.json'
imgs = r''
...
def init(key, iv):
    ...
    cfg.MODEL.WEIGHTS = r"/media/ps/train/LQ/trt/trt/model/model_0413999.pth"
    
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.1
    cfg.MODEL.FCOS.INFERENCE_TH_TEST = 0.01
...
def predict(*image):
    ...
    sub_save_dir = r"/media/ps/train/LQ/trt/trt/model/pinf"
    ...
    #             print(s,"**", cid)
    #             # pass
    print("保存的图片名称",imn_orig,"------",set(classes[0]))
...
if __name__ == "__main__":
    ...
    src = r"/media/ps/train/LQ/trt/trt/datasets"
