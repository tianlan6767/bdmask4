...
if __name__ == "__main__":
    ...
    blender_top_feat = torch.zeros((1, 784)).to(DEVICE)
    blender_inputs = [blender_bases, blender_box, blender_top_feat]
    blender = Blender().eval()
    blender_input_name = ["bases", "box", "top_feat"]
    blender_output_name = ["mask_pred"]
    blender_out = blender(blender_inputs)
    
    blender_output = r"/media/ps/data/train/LQ/project/OQC/train/device/0801/model_blender.onnx"
