...
int main(){
    string fcos_engine_path = R"(/media/ps/data1/train/HJL/test/testmodel/model_0887999.trtmodel)";
    BdmApp bdmapp;
    shared_ptr<Fcos::Infer> fcos1 = nullptr;
    // shared_ptr<Fcos::Infer> fcos2 = nullptr;
    int device_id1 = 2;
    // int device_id2 = 3;
    float mean[] = {85.12,85.12,85.12};
    float std[] = {59.53,59.53,59.53};
    ...
    string src = R"(/media/ps/data1/train/HJL/test/1/*.jpg)";
    string dst = R"(/media/ps/data1/train/HJL/test/inf)";
    iLogger::rmtree(dst);
    iLogger::mkdir(dst);
