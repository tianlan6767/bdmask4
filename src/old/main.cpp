...
// int main(){
//     string fcos_engine_path = R"(/media/ps/data/train/LQ/task/bdm/bdmask/workspace/tmp/imgs2/model_1573999.trtmodel)";
//     BdmApp bdmapp;
...
//     string src = R"(/media/ps/data/train/LQ/task/bdm/bdmask/workspace/tmp/imgs2/*.bmp)";
//     string dst = R"(/media/ps/data/train/LQ/task/bdm/bdmask/workspace/tmp/inf3)";
//     iLogger::rmtree(dst);
//     iLogger::mkdir(dst);
...
//     batch_pref(fcos1, files, dst, noc_num, avg_times_single, resjson_single);
